        ...
        <div className="revealContainer">
          ...
          <div className="rightContainer">
            ...
            <div className="discription">
              Unleash the power of secure & FCRA complaint background checks and
              make informed decisions with our reliable and customizable
              service.
            </div>
            ...
            <form>
              ...
              <div className="">
                ...
                <div id="emailHelp" className="form-text messageSize">
                  This will also be your username when you return in the future
                </div>
              </div>
              <div className="">
                <label
